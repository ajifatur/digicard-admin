...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-line-chart"></i> Low Customer</h1>
      <p>Menu untuk menampilkan data customer dengan transaksi kurang dari Rp 40.000 per bulan</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item"><a href="/admin/transaksi">Report</a></li>
      <li class="breadcrumb-item">Low Customer</li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-title-w-btn">
          <h3 class="title">Low Customer</h3>
          <div class="btn-group">
...
<script type="text/javascript">
  ...
  $(document).on("change", "#bulan, #tahun", function(){
    var bulan = $("#bulan").val();
    var tahun = $("#tahun").val();
	window.location.href = '/admin/report/low-customer?bulan='+bulan+'&tahun='+tahun;
  });
</script>
