...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-line-chart"></i> Middle Customer</h1>
      <p>Menu untuk menampilkan data customer dengan transaksi Rp 40.000 - Rp 75.000 per bulan</p>
    </div>
    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-title-w-btn">
          <h3 class="title">Middle Customer</h3>
          <div class="btn-group">
...
<script type="text/javascript">
  ...
  $(document).on("change", "#bulan, #tahun", function(){
    var bulan = $("#bulan").val();
    var tahun = $("#tahun").val();
	window.location.href = '/admin/report/middle-customer?bulan='+bulan+'&tahun='+tahun;
  });
</script>
