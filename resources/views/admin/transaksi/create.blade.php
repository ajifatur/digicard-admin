...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-money"></i> Tambah Transaksi</h1>
      <p>Menu untuk menambah data transaksi</p>
    </div>
      ...
      <div class="tile">
        <form method="post" action="/admin/transaksi/store">
            ...
            <div class="tile-title-w-btn">
                <h3 class="title">Tambah Transaksi</h3>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="nama" id="nama" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}">
                            ...
                            <option value="{{ $data->id_user }}">{{ $data->username }} - {{ $data->nama_user }}</option>
                            @endforeach
                        </select>
                        @if($errors->has('nama'))
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" id="jenis-transaksi-1" type="radio" name="jenis_transaksi" value="1" checked>Top Up
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" id="jenis-transaksi-2" type="radio" name="jenis_transaksi" value="2">TRX
                            </label>
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="tanggal_transaksi" class="form-control {{ $errors->has('tanggal_transaksi') ? 'is-invalid' : '' }}" value="{{ old('tanggal_transaksi') }}" placeholder="Masukkan Tanggal Transaksi">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="jam_transaksi" class="form-control {{ $errors->has('jam_transaksi') ? 'is-invalid' : '' }}" value="{{ old('jam_transaksi') }}" placeholder="Masukkan Jam Transaksi">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nominal_transaksi" class="form-control number-only thousand-format {{ $errors->has('nominal_transaksi') ? 'is-invalid' : '' }}" value="{{ old('nominal_transaksi') }}" placeholder="Masukkan Nominal Transaksi">
                        </div>
