            ...
            <div class="tile-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="username" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" value="{{ old('username') }}" placeholder="Masukkan Tag">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="nomor_hp" class="form-control {{ $errors->has('nomor_hp') ? 'is-invalid' : '' }}" value="{{ old('nomor_hp') }}" placeholder="Masukkan Nomor HP">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="tanggal_lahir" class="form-control {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" value="{{ old('tanggal_lahir') }}" placeholder="Masukkan Tanggal Lahir">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" id="jenis-kelamin-1" type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }}>Laki-Laki
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" id="jenis-kelamin-2" type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }}>Perempuan
                            </label>
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="pekerjaan" class="form-control {{ $errors->has('pekerjaan') ? 'is-invalid' : '' }}" value="{{ old('pekerjaan') }}" placeholder="Masukkan Pekerjaan">
