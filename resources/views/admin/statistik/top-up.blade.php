...
@section('title', 'Statistik Top Up')
...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-line-chart"></i> Statistik Top Up</h1>
      <p>Menu untuk menampilkan statistik top up</p>
    </div>
...
<script type="text/javascript">
  ...
  $(document).on("change", "#bulan, #tahun", function(){
	...
	function graph_transaksi(bulan, tahun){
		$.ajax({
			type: "get",
			url: "/admin/ajax/graph-top-up?bulan="+bulan+"&tahun="+tahun,
