...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-line-chart"></i> Statistik TRX</h1>
      <p>Menu untuk menampilkan statistik TRX</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item"><a href="#">Statistik</a></li>
      <li class="breadcrumb-item">TRX</li>
    </ul>
  </div>
  <div class="row">
    <div class="col-lg-12">
...
<script type="text/javascript">
  ...
  $(document).on("change", "#bulan, #tahun", function(){
	...
	function graph_transaksi(bulan, tahun){
		$.ajax({
			type: "get",
			url: "/admin/ajax/graph-trx?bulan="+bulan+"&tahun="+tahun,
